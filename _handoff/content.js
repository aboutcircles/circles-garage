// content.js — MOCK CONTENT for the wireframes.
// ╔══════════════════════════════════════════════════════════════════╗
...
const C = {
  ...
  program: {
    ...
    poolSplit: { winners: 2, life: 1, denom: 3, winnersAmt: '€332.80', lifeAmt: '€166.40' },
  },
  ...
  landing: {
    ...
    steps: [
      ...
      ['ii.',  'register a mini-app', 'contracts · repo · live link. we wire up the meter.'],
      ['iii.', 'get measured. get paid.', 'every monday. ⅔ to top movers, ⅓ to apps still moving.'],
    ],
    manifesto: [
  ...
  leaderboard: [
    { rank: 1,  builder: 'splits.eth',  org: 'pocket-collective', app: 'dropparty',   pitch: 'split a tab, mint to non-holders', mints: '+412', vol: '€11.0k', payout: '€124.30', streak: '6w',  star: true },
    { rank: 2,  builder: 'manyfold',    org: 'manyfold-labs',     app: 'pocket-mint', pitch: 'NFC tap-to-mint stickers',          mints: '+298', vol: '€2.1k',  payout: '€89.40',  streak: '3w' },
    { rank: 3,  builder: 'haylee.crc',  org: 'café-tab',          app: 'café-tab',    pitch: 'café tabs paid in CRC',             mints: '+187', vol: '€840',   payout: '€56.10',  streak: '11w', star: true },
    { rank: 4,  builder: 'ofgr.eth',    org: 'ofgr-ofgr',         app: 're/circle',   pitch: 'weekly recap of your circle',       mints: '+142', vol: '€420',   payout: '€42.60',  streak: '1w' },
    { rank: 5,  builder: '0xcap.eth',   org: 'bzzar-collective',  app: 'bzzar',       pitch: 'p2p marketplace for IRL stuff',     mints: '+97',  vol: '€1.2k',  payout: '€29.10',  streak: '—' },
    { rank: 6,  builder: 'minae',       org: 'sourdough',         app: 'crumb',       pitch: 'group orders for local bakeries',   mints: '+74',  vol: '€620',   payout: '€22.20',  streak: '4w' },
    { rank: 7,  builder: 'rxiv',        org: 'rxiv-rxiv',         app: 'tonight',     pitch: 'pop-up event tickets',              mints: '+58',  vol: '€310',   payout: '€17.40',  streak: '2w' },
    { rank: 8,  builder: 'noxe',        org: 'noxe-eth',          app: 'splitsie',    pitch: 'flatmate bill splits',              mints: '+47',  vol: '€150',   payout: '€14.10',  streak: '7w',  star: true },
    { rank: 9,  builder: 'p.sundae',    org: 'sundae-coop',       app: 'cone',        pitch: 'ice cream stamp card',              mints: '+31',  vol: '€90',    payout: '€9.30',   streak: '—',   muted: true },
    { rank: 10, builder: 'kab.eth',     org: 'kab-studio',        app: 'thread',      pitch: 'invite-only msg threads',           mints: '+24',  vol: '€60',    payout: '€7.20',   streak: '1w' },
    { rank: 11, builder: 'oyl',         org: 'oyl-house',         app: 'tab',         pitch: 'rolling open tab w/ friends',       mints: '+18',  vol: '€40',    payout: '€5.40',   streak: '—',   muted: true },
    { rank: 12, builder: 'wenmoon.crc', org: 'wenmoon',           app: 'whenwen',     pitch: 'when2meet but on-chain',            mints: '+12',  vol: '€20',    payout: '€3.60',   streak: '—',   muted: true },
  ],
  ...
  me: {
    ...
    coLifeWeeks: 6,
    apps: [
      { name: 'dropparty',   status: 'LIVE',  wau: '+286', vol: '€11k',  streak: '6w', line: 'splits a tab between everyone at a party, mints to non-holders', chart: [3,4,6,9,12,11,14,18,21,28] },
      { name: 'pocket-mint', status: 'LIVE',  wau: '+126', vol: '€2.1k', streak: '2w', line: 'tap-to-mint NFC stickers, redeemable for CRC drinks',           chart: [1,2,2,3,4,6,5,8,10,12] },
      { name: 're/circle',   status: 'DRAFT', wau: '—',    vol: '—',     streak: '—',  line: 'weekly recap of who in your circle minted what',                 chart: [], muted: true },
    ],
    activity: [
  ...
  signup: {
    sections: [
      { num: '01', label: 'you', hint: '3 fields, all required', fields: [
        { label: 'handle',            required: true, placeholder: 'splits.eth' },
        { label: 'reach',             required: true, placeholder: 'telegram / farcaster / email' },
        { label: 'circles addr (v2)', required: true, placeholder: '0x____________________________________', hint: 'we use this to pay you & verify org ownership' },
      ]},
      { num: '02', label: 'your circle', hint: 'org you submit under', fields: [
        { label: 'circles org address', required: true, placeholder: '0x____________________________________' },
        { label: 'team members',        placeholder: '0x…, 0x…, 0x…', hint: 'comma-separated CRC addresses' },
      ]},
      { num: '03', label: 'the app · light touch', hint: 'you can add the rest later', fields: [
        { label: 'working name',  required: true, placeholder: 'pocket-mint' },
        { label: 'track',         placeholder: 'payments | social | games | tools | other' },
        { label: 'one-line pitch', placeholder: 'what does it do in one breath' },
      ]},
    ],
    consent: 'I read the rules. The weekly snapshot is final. My handle & numbers can show on the public leaderboard.',
    benefits: [
    ...
    benefitsMuted: [
      'co-marketing when top-3',
    ],
    notice: { head: 'no kyc · no fee', body: 'just keep your circles org sig & we\'re good.' },
  },
  ...
  draft: {
    ...
    contracts: [
      ...
      { chain: 'gno', addr: '0x9911…c0e0', label: 'redemption', verified: true },
    ],
    readme: {
